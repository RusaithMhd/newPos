...
const PurchaseReturn = () => {
    ...
    const handleSubmitReturn = () => {
        if (newReturn.invoiceNumber && newReturn.supplierName && newReturn.items.length > 0) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-6 dark:bg-gray-900">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-6">Purchase Return Dashboard</h1>
                ...
                <div className="mb-8">
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Purchase Return Form</h2>
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                <div>
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Purchase Return History</h2>
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
                        <table className="min-w-full">
                            <thead>
                                <tr>
                                    <th className="px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200">Invoice Number</th>
                                    <th className="px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200">Supplier Name</th>
                            ...
                            <tbody>
                                {returnItems.map((returnItem, index) => (
                                    <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-200">
                                        ...
                                        <td className="px-4 py-2 text-sm text-gray-700 dark:text-gray-200">{returnItem.supplierName}</td>
